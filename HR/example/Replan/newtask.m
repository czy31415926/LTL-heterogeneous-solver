...
formula1='Fp4&Fp5&((!p4)Up5)';
task1=[[2,2,1];[3,2,3];[2,2,2];[5,5,5];[2,2,2]];
...
point.dis=0;
for i=1:length(agent)
    point.p_pre=[point.p_pre;tree_code.p_pre];
    point.t_pre=[point.t_pre;tree_code.t_pre];
end
